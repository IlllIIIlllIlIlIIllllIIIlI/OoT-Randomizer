...
def assume_entrance_pool(entrance_pool: list[Entrance]) -> list[Entrance]:
    ...
    for entrance in entrance_pool:
        ...
        if entrance.reverse is not None:
            ...
            if (
                entrance.type in ("Dungeon", "Grotto", "Grave")
                and entrance.reverse.name
                != "Spirit Temple Lobby -> Desert Colossus From Spirit Lobby"
            ) or (
                entrance.type == "Interior"
                and entrance.world
                and entrance.world.shuffle_special_interior_entrances
            ):
...
def build_one_way_targets(
    world: World,
    types_to_include: Iterable[str],
    exclude: Container[str] = (),
    target_region_names: Container[str] = (),
) -> list[Entrance]:
    ...
    valid_one_way_entrances = list(
        filter(lambda entrance: entrance.name not in exclude, one_way_entrances)
    )
...
entrance_shuffle_table = [
    (
        "Dungeon",
        ("KF Outside Deku Tree -> Deku Tree Lobby", {"index": 0x0000}),
        ("Deku Tree Lobby -> KF Outside Deku Tree", {"index": 0x0209}),
    ),
    (
        "Dungeon",
        ("Death Mountain -> Dodongos Cavern Beginning", {"index": 0x0004}),
        ("Dodongos Cavern Beginning -> Death Mountain", {"index": 0x0242}),
    ),
    (
        "Dungeon",
        ("Zoras Fountain -> Jabu Jabus Belly Beginning", {"index": 0x0028}),
        ("Jabu Jabus Belly Beginning -> Zoras Fountain", {"index": 0x0221}),
    ),
    (
        "Dungeon",
        ("SFM Forest Temple Entrance Ledge -> Forest Temple Lobby", {"index": 0x0169}),
        ("Forest Temple Lobby -> SFM Forest Temple Entrance Ledge", {"index": 0x0215}),
    ),
    (
        "Dungeon",
        ("DMC Fire Temple Entrance -> Fire Temple Lower", {"index": 0x0165}),
        ("Fire Temple Lower -> DMC Fire Temple Entrance", {"index": 0x024A}),
    ),
    (
        "Dungeon",
        ("Lake Hylia -> Water Temple Lobby", {"index": 0x0010}),
        ("Water Temple Lobby -> Lake Hylia", {"index": 0x021D}),
    ),
    (
        "Dungeon",
        ("Graveyard Warp Pad Region -> Shadow Temple Entryway", {"index": 0x0037}),
        ("Shadow Temple Entryway -> Graveyard Warp Pad Region", {"index": 0x0205}),
    ),
    (
        "Dungeon",
        ("Desert Colossus -> Spirit Temple Lobby", {"index": 0x0082}),
        ("Spirit Temple Lobby -> Desert Colossus From Spirit Lobby", {"index": 0x01E1}),
    ),
    (
        "Dungeon",
        ("Kakariko Village -> Bottom of the Well", {"index": 0x0098}),
        ("Bottom of the Well -> Kakariko Village", {"index": 0x02A6}),
    ),
    (
        "Dungeon",
        ("ZF Ice Ledge -> Ice Cavern Beginning", {"index": 0x0088}),
        ("Ice Cavern Beginning -> ZF Ice Ledge", {"index": 0x03D4}),
    ),
    (
        "Dungeon",
        ("Gerudo Fortress -> Gerudo Training Ground Lobby", {"index": 0x0008}),
        ("Gerudo Training Ground Lobby -> Gerudo Fortress", {"index": 0x03A8}),
    ),
    (
        "DungeonSpecial",
        ("Ganons Castle Grounds -> Ganons Castle Lobby", {"index": 0x0467}),
    ...
    (
        ...
        (
            ...
            {"index": 0x040F, "savewarp_addresses": [0xB06292, 0xBC6162, 0xBC60AE]},
        ),
    ...
    (
        ...
        (
            ...
            {"index": 0x040B, "savewarp_addresses": [0xB062B6, 0xBC616E]},
        ),
    ...
    (
        ...
        (
            ...
            {"index": 0x0301, "savewarp_addresses": [0xB062C2, 0xBC60C2]},
        ),
    ...
    (
        ...
        (
            ...
            {"index": 0x000C, "savewarp_addresses": [0xB062CE, 0xBC6182]},
        ),
    ...
    (
        ...
        (
            ...
            {"index": 0x0305, "savewarp_addresses": [0xB062DA, 0xBC60CE]},
        ),
    ...
    (
        ...
        (
            ...
            {"index": 0x0417, "savewarp_addresses": [0xB062E6, 0xBC6196]},
        ),
    ...
    (
        ...
        (
            ...
            {"index": 0x0413, "savewarp_addresses": [0xB062FE, 0xBC61AA]},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x00, "entrance": 0x05BC, "content": 0xFD, "scene": 0x5C},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x01, "entrance": 0x05A4, "content": 0xEF, "scene": 0x57},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x02, "entrance": 0x05BC, "content": 0xEB, "scene": 0x54},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x03, "entrance": 0x036D, "content": 0xE6, "scene": 0x54},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x04, "entrance": 0x003F, "content": 0x29, "scene": 0x54},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x05, "entrance": 0x05A4, "content": 0xF9, "scene": 0x61},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x06, "entrance": 0x003F, "content": 0x7A, "scene": 0x61},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x07, "entrance": 0x05A4, "content": 0xFB, "scene": 0x62},
        ),
        ("GC Grotto -> GC Grotto Platform", {"grotto_id": 0x07, "savewarp_fallback": 0x014D}),
    ),  # TODO (out-of-logic access to Goron City)
    (
        "Grotto",
        (
            "Death Mountain -> DMT Storms Grotto",
            {"grotto_id": 0x08, "entrance": 0x003F, "content": 0x57, "scene": 0x60},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x09, "entrance": 0x05FC, "content": 0xF8, "scene": 0x60},
        ),
        (
            "DMT Cow Grotto -> Death Mountain Summit",
            {"grotto_id": 0x09, "savewarp_fallback": 0x045B},
        ),
    ),
    (
        "Grotto",
        (
            ...
            {"grotto_id": 0x0A, "entrance": 0x003F, "content": 0x28, "scene": 0x52},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x0B, "entrance": 0x05A0, "content": 0xE7, "scene": 0x52},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x0C, "entrance": 0x05B8, "content": 0xF6, "scene": 0x5F},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x0D, "entrance": 0x05C0, "content": 0xE1, "scene": 0x51},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x0E, "entrance": 0x0598, "content": 0xE5, "scene": 0x51},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x0F, "entrance": 0x036D, "content": 0xFF, "scene": 0x51},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x10, "entrance": 0x003F, "content": 0x00, "scene": 0x51},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x11, "entrance": 0x05A8, "content": 0xE4, "scene": 0x51},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x12, "entrance": 0x059C, "content": 0xE6, "scene": 0x51},
        ),
        (
            "HF Inside Fence Grotto -> Hyrule Field",
            {"grotto_id": 0x12, "savewarp_fallback": 0x0189},
        ),
    ),
    (
        "Grotto",
        (
            ...
            {"grotto_id": 0x13, "entrance": 0x003F, "content": 0x03, "scene": 0x51},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x14, "entrance": 0x003F, "content": 0x22, "scene": 0x51},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x15, "entrance": 0x05A4, "content": 0xFC, "scene": 0x63},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x16, "entrance": 0x05B4, "content": 0xED, "scene": 0x56},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x17, "entrance": 0x05BC, "content": 0xEE, "scene": 0x56},
        ),
        (
            "SFM Storms Grotto -> Sacred Forest Meadow",
            {"grotto_id": 0x17, "savewarp_fallback": 0x0600},
        ),
    ),
    (
        "Grotto",
        (
            ...
            {"grotto_id": 0x18, "entrance": 0x036D, "content": 0xFF, "scene": 0x56},
        ),
        (
            "SFM Fairy Grotto -> Sacred Forest Meadow",
            {"grotto_id": 0x18, "savewarp_fallback": 0x0600},
        ),
    ),
    (
        "Grotto",
        (
            ...
            {"grotto_id": 0x19, "entrance": 0x05B0, "content": 0xF5, "scene": 0x5B},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x1A, "entrance": 0x003F, "content": 0x14, "scene": 0x5B},
        ),
        (
            "LW Near Shortcuts Grotto -> Lost Woods",
            {"grotto_id": 0x1A, "savewarp_fallback": 0x04D6},
        ),
    ),
    (
        "Grotto",
        (
            ...
            {"grotto_id": 0x1B, "entrance": 0x003F, "content": 0x2C, "scene": 0x55},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x1C, "entrance": 0x036D, "content": 0xFF, "scene": 0x58},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x1D, "entrance": 0x036D, "content": 0xFF, "scene": 0x5D},
        ),
        (
            "GF Storms Grotto -> GF Entrances Behind Crates",
            {"grotto_id": 0x1D, "savewarp_fallback": 0x0235},
        ),
    ),
    (
        "Grotto",
        (
            ...
            {"grotto_id": 0x1E, "entrance": 0x05BC, "content": 0xF0, "scene": 0x5A},
        ),
    ...
    (
        ...
        (
            ...
            {"grotto_id": 0x1F, "entrance": 0x05AC, "content": 0xF2, "scene": 0x5A},
        ),
        ("GV Octorok Grotto -> GV Grotto Ledge", {"grotto_id": 0x1F, "savewarp_fallback": 0x0117}),
    ),  # TODO (out-of-logic access to Gerudo Valley)
    (
        "Grotto",
        (
            "LW Beyond Mido -> Deku Theater",
            {"grotto_id": 0x20, "entrance": 0x05C4, "content": 0xF3, "scene": 0x5B},
        ),
        ("Deku Theater -> LW Beyond Mido", {"grotto_id": 0x20, "savewarp_fallback": 0x01A9}),
    ),
    (
        "Grave",
        ("Graveyard -> Graveyard Shield Grave", {"index": 0x004B}),
        ("Graveyard Shield Grave -> Graveyard", {"index": 0x035D}),
    ),
    (
        "Grave",
        ("Graveyard -> Graveyard Heart Piece Grave", {"index": 0x031C}),
        ("Graveyard Heart Piece Grave -> Graveyard", {"index": 0x0361}),
    ),
    (
        "Grave",
        ("Graveyard -> Graveyard Royal Familys Tomb", {"index": 0x002D}),
        ("Graveyard Royal Familys Tomb -> Graveyard", {"index": 0x050B}),
    ),
    (
        "Grave",
        ("Graveyard -> Graveyard Dampes Grave", {"index": 0x044F}),
        ("Graveyard Dampes Grave -> Graveyard", {"index": 0x0359}),
    ),
    (
        "Overworld",
        ("Kokiri Forest -> LW Bridge From Forest", {"index": 0x05E0}),
        ("LW Bridge -> Kokiri Forest", {"index": 0x020D}),
    ),
    (
        "Overworld",
        ("Kokiri Forest -> Lost Woods", {"index": 0x011E}),
        ("LW Forest Exit -> Kokiri Forest", {"index": 0x0286}),
    ),
    (
        "Overworld",
        ("Lost Woods -> GC Woods Warp", {"index": 0x04E2}),
        ("GC Woods Warp -> Lost Woods", {"index": 0x04D6}),
    ),
    (
        "Overworld",
        ("Lost Woods -> Zora River", {"index": 0x01DD}),
        ("Zora River -> LW Underwater Entrance", {"index": 0x04DA}),
    ),
    (
        "Overworld",
        ("LW Beyond Mido -> SFM Entryway", {"index": 0x00FC}),
        ("SFM Entryway -> LW Beyond Mido", {"index": 0x01A9}),
    ),
    (
        "Overworld",
        ("LW Bridge -> Hyrule Field", {"index": 0x0185}),
        ("Hyrule Field -> LW Bridge", {"index": 0x04DE}),
    ),
    (
        "Overworld",
        ("Hyrule Field -> Lake Hylia", {"index": 0x0102}),
        ("Lake Hylia -> Hyrule Field", {"index": 0x0189}),
    ),
    (
        "Overworld",
        ("Hyrule Field -> Gerudo Valley", {"index": 0x0117}),
        ("Gerudo Valley -> Hyrule Field", {"index": 0x018D}),
    ),
    (
        "Overworld",
        ("Hyrule Field -> Market Entrance", {"index": 0x0276}),
        ("Market Entrance -> Hyrule Field", {"index": 0x01FD}),
    ),
    (
        "Overworld",
        ("Hyrule Field -> Kakariko Village", {"index": 0x00DB}),
        ("Kakariko Village -> Hyrule Field", {"index": 0x017D}),
    ),
    (
        "Overworld",
        ("Hyrule Field -> ZR Front", {"index": 0x00EA}),
        ("ZR Front -> Hyrule Field", {"index": 0x0181}),
    ),
    (
        "Overworld",
        ("Hyrule Field -> Lon Lon Ranch", {"index": 0x0157}),
        ("Lon Lon Ranch -> Hyrule Field", {"index": 0x01F9}),
    ),
    (
        "Overworld",
        ("Lake Hylia -> Zoras Domain", {"index": 0x0328}),
        ("Zoras Domain -> Lake Hylia", {"index": 0x0560}),
    ),
    (
        "Overworld",
        ("GV Fortress Side -> Gerudo Fortress", {"index": 0x0129}),
        ("Gerudo Fortress -> GV Fortress Side", {"index": 0x022D}),
    ),
    (
        "Overworld",
        ("GF Outside Gate -> Wasteland Near Fortress", {"index": 0x0130}),
        ("Wasteland Near Fortress -> GF Outside Gate", {"index": 0x03AC}),
    ),
    (
        "Overworld",
        ("Wasteland Near Colossus -> Desert Colossus", {"index": 0x0123}),
        ("Desert Colossus -> Wasteland Near Colossus", {"index": 0x0365}),
    ),
    (
        "Overworld",
        ("Market Entrance -> Market", {"index": 0x00B1}),
        ("Market -> Market Entrance", {"index": 0x0033}),
    ),
    (
        "Overworld",
        ("Market -> Castle Grounds", {"index": 0x0138}),
        ("Castle Grounds -> Market", {"index": 0x025A}),
    ),
    (
        "Overworld",
        ("Market -> ToT Entrance", {"index": 0x0171}),
        ("ToT Entrance -> Market", {"index": 0x025E}),
    ),
    (
        "Overworld",
        ("Kakariko Village -> Graveyard", {"index": 0x00E4}),
        ("Graveyard -> Kakariko Village", {"index": 0x0195}),
    ),
    (
        "Overworld",
        ("Kak Behind Gate -> Death Mountain", {"index": 0x013D}),
        ("Death Mountain -> Kak Behind Gate", {"index": 0x0191}),
    ),
    (
        "Overworld",
        ("Death Mountain -> Goron City", {"index": 0x014D}),
        ("Goron City -> Death Mountain", {"index": 0x01B9}),
    ),
    (
        "Overworld",
        ("GC Darunias Chamber -> DMC Lower Local", {"index": 0x0246}),
        ("DMC Lower Nearby -> GC Darunias Chamber", {"index": 0x01C1}),
    ),
    (
        "Overworld",
        ("Death Mountain Summit -> DMC Upper Local", {"index": 0x0147}),
        ("DMC Upper Nearby -> Death Mountain Summit", {"index": 0x01BD}),
    ),
    (
        "Overworld",
        ("ZR Behind Waterfall -> Zoras Domain", {"index": 0x0108}),
        ("Zoras Domain -> ZR Behind Waterfall", {"index": 0x019D}),
    ),
    (
        "Overworld",
        ("ZD Behind King Zora -> Zoras Fountain", {"index": 0x0225}),
    ...
    (
        "OwlDrop",
        ("DMT Owl Flight -> Kak Impas Rooftop", {"index": 0x0554, "addresses": [0xAC9EF2]}),
    ),
    ...
    (
        ...
        (
            ...
            {"index": 0x0600, "addresses": [0xBF023C]},
        ),
    ),
    (
        "WarpSong",
        ("Bolero of Fire Warp -> DMC Central Local", {"index": 0x04F6, "addresses": [0xBF023E]}),
    ),
    (
        "WarpSong",
        ("Serenade of Water Warp -> Lake Hylia", {"index": 0x0604, "addresses": [0xBF0240]}),
    ),
    (
        "WarpSong",
        ("Requiem of Spirit Warp -> Desert Colossus", {"index": 0x01F1, "addresses": [0xBF0242]}),
    ),
    (
        "WarpSong",
        (
            "Nocturne of Shadow Warp -> Graveyard Warp Pad Region",
            {"index": 0x0568, "addresses": [0xBF0244]},
        ),
    ),
    (
        "WarpSong",
        ("Prelude of Light Warp -> Temple of Time", {"index": 0x05F4, "addresses": [0xBF0246]}),
    ),
    (
        "BlueWarp",
        (
            "Queen Gohma Boss Room -> KF Outside Deku Tree",
            {"index": 0x0457, "addresses": [0xAC93A2, 0xCA3142, 0xCA316A]},
        ),
    ),
    (
        "BlueWarp",
        (
            "King Dodongo Boss Room -> Death Mountain",
            {"index": 0x047A, "addresses": [0xAC9336, 0xCA30CA, 0xCA30EA]},
        ),
    ),
    (
        "BlueWarp",
        (
            "Barinade Boss Room -> Zoras Fountain",
            {"index": 0x010E, "addresses": [0xAC936A, 0xCA31B2, 0xCA3702]},
        ),
    ),
    (
        "BlueWarp",
        (
            "Phantom Ganon Boss Room -> Sacred Forest Meadow",
            {
                "index": 0x0608,
                "addresses": [0xAC9F96, 0xCA3D66, 0xCA3D5A, 0xCA3D32],
                "child_index": 0x0600,
            },
        ),
    ),
    (
        "BlueWarp",
        (
            "Volvagia Boss Room -> DMC Central Local",
            {
                "index": 0x0564,
                "addresses": [0xACA516, 0xCA3DF2, 0xCA3DE6, 0xCA3DBE],
                "child_index": 0x04F6,
            },
        ),
    ),
    (
        "BlueWarp",
        (
            "Morpha Boss Room -> Lake Hylia",
            {
                "index": 0x060C,
                "addresses": [0xAC995A, 0xCA3E82, 0xCA3E76, 0xCA3E4A],
                "child_index": 0x0604,
            },
        ),
    ),
    (
        "BlueWarp",
        (
            "Bongo Bongo Boss Room -> Graveyard Warp Pad Region",
            {
                "index": 0x0580,
                "addresses": [0xACA496, 0xCA3FA2, 0xCA3F96, 0xCA3F6A],
                "child_index": 0x0568,
            },
        ),
    ),
    (
        "BlueWarp",
        (
            "Twinrova Boss Room -> Desert Colossus",
            {
                "index": 0x0610,
                "addresses": [0xACA402, 0xCA3F12, 0xCA3F06, 0xCA3EDA],
                "child_index": 0x01F1,
            },
        ),
    ),
...
priority_entrance_table = {
    ...
    "Nocturne": (
        ...
        ["OwlDrop", "Spawn", "WarpSong", "OverworldOneWay"],
    ),
    "Requiem": (
        ["Desert Colossus", "Desert Colossus From Spirit Lobby"],
        ["OwlDrop", "Spawn", "WarpSong", "OverworldOneWay"],
    ),
}
...
def shuffle_random_entrances(worlds: list[World]) -> None:
    ...
    complete_itempool = [
        item for world in worlds for item in world.get_itempool_with_dungeon_items()
    ]
    ...
    non_drop_locations = [
        ...
        if location.type not in ("Drop", "Event")
    ]
    ...
    for world in worlds:
        ...
        if worlds[0].settings.shuffle_gerudo_valley_river_exit:
            one_way_entrance_pools["OverworldOneWay"] = world.get_shufflable_entrances(
        ...
        if worlds[0].settings.spawn_positions:
            ...
            if "child" not in worlds[0].settings.spawn_positions:
                one_way_entrance_pools["Spawn"].remove(
                    world.get_entrance("Child Spawn -> KF Links House")
                )
            elif "adult" not in worlds[0].settings.spawn_positions:
                one_way_entrance_pools["Spawn"].remove(
                    world.get_entrance("Adult Spawn -> Temple of Time")
                )

        if worlds[0].settings.warp_songs:
            one_way_entrance_pools["WarpSong"] = world.get_shufflable_entrances(type="WarpSong")
            if (
                worlds[0].settings.reachable_locations != "beatable"
                and worlds[0].settings.logic_rules == "glitchless"
            ):
                ...
                if worlds[0].settings.reachable_locations == "all" or (
                    "tokens" in wincons and worlds[0].settings.tokensanity in ("off", "dungeons")
                ):
                ...
                if (
                    ...
                    or (
                        "tokens" in wincons
                        and worlds[0].settings.tokensanity in ("off", "overworld")
                    )
                ):
        ...
        if worlds[0].settings.shuffle_bosses == "full":
            entrance_pools["Boss"] = world.get_shufflable_entrances(
                type="ChildBoss", only_primary=True
            )
            entrance_pools["Boss"] += world.get_shufflable_entrances(
                type="AdultBoss", only_primary=True
            )
            if worlds[0].settings.open_forest == "closed":
                ...
                entrance_pools["Boss"].remove(
                    world.get_entrance("Deku Tree Before Boss -> Queen Gohma Boss Room")
                )
        elif worlds[0].settings.shuffle_bosses == "limited":
            entrance_pools["ChildBoss"] = world.get_shufflable_entrances(
                type="ChildBoss", only_primary=True
            )
            entrance_pools["AdultBoss"] = world.get_shufflable_entrances(
                type="AdultBoss", only_primary=True
            )
            if worlds[0].settings.open_forest == "closed":
                # Deku is forced vanilla below, so Queen Gohma must be vanilla to ensure she is reachable.
                # This is already enforced by the fill algorithm in most cases, but this covers the odd settings combination where it isn't.
                entrance_pools["ChildBoss"].remove(
                    world.get_entrance("Deku Tree Before Boss -> Queen Gohma Boss Room")
                )

        if worlds[0].shuffle_dungeon_entrances:
            entrance_pools["Dungeon"] = world.get_shufflable_entrances(
                type="Dungeon", only_primary=True
            )
            ...
            if worlds[0].settings.open_forest == "closed":
                entrance_pools["Dungeon"].remove(
                    world.get_entrance("KF Outside Deku Tree -> Deku Tree Lobby")
                )
            if worlds[0].shuffle_special_dungeon_entrances:
                entrance_pools["Dungeon"] += world.get_shufflable_entrances(
                    type="DungeonSpecial", only_primary=True
                )

        if worlds[0].shuffle_interior_entrances:
            entrance_pools["Interior"] = world.get_shufflable_entrances(
                type="Interior", only_primary=True
            )
            if worlds[0].shuffle_special_interior_entrances:
                entrance_pools["Interior"] += world.get_shufflable_entrances(
                    type="SpecialInterior", only_primary=True
                )
            if worlds[0].settings.shuffle_hideout_entrances:
                entrance_pools["Interior"] += world.get_shufflable_entrances(
                    type="Hideout", only_primary=True
                )

        if worlds[0].settings.shuffle_grotto_entrances:
            entrance_pools["GrottoGrave"] = world.get_shufflable_entrances(
                type="Grotto", only_primary=True
            )
            entrance_pools["GrottoGrave"] += world.get_shufflable_entrances(
                type="Grave", only_primary=True
            )
        ...
        for entrance in list(chain.from_iterable(one_way_entrance_pools.values())) + list(
            chain.from_iterable(entrance_pools.values())
        ):
        ...
        for pool_type, entrance_pool in one_way_entrance_pools.items():
            ...
            if pool_type == "OverworldOneWay":
                ...
                one_way_target_entrance_pools[pool_type] = build_one_way_targets(
                    world, valid_target_types, exclude=["Prelude of Light Warp -> Temple of Time"]
                )
            ...
            for target in one_way_target_entrance_pools[pool_type]:
                target.add_rule(
                    (
                        lambda entrances=entrance_pool: (
                            lambda state, **kwargs: any(
        ...
        world.distribution.set_shuffled_entrances(
            worlds,
            {**one_way_entrance_pools, **entrance_pools},
            {**one_way_target_entrance_pools, **target_entrance_pools},
            locations_to_ensure_reachable,
            complete_itempool,
        )
        ...
        placed_one_way_entrances = shuffle_one_way_priority_entrances(
            worlds,
            world,
            one_way_priorities,
        ...
        replaced_entrances = [
            entrance.replaces for entrance in chain.from_iterable(one_way_entrance_pools.values())
        ]
        for remaining_target in chain.from_iterable(one_way_target_entrance_pools.values()):
        ...
        for pool_type, entrance_pool in one_way_entrance_pools.items():
            placed_one_way_entrances += shuffle_entrance_pool(
                world,
                worlds,
                entrance_pool,
        ...
        boss_exits = {
            "Queen Gohma Boss Room -> Deku Tree Before Boss": world.get_entrance(
                "Deku Tree Lobby -> KF Outside Deku Tree"
            ),
            "King Dodongo Boss Room -> Dodongos Cavern Mouth": world.get_entrance(
                "Dodongos Cavern Beginning -> Death Mountain"
            ),
            "Barinade Boss Room -> Jabu Jabus Belly Before Boss": world.get_entrance(
                "Jabu Jabus Belly Beginning -> Zoras Fountain"
            ),
            "Phantom Ganon Boss Room -> Forest Temple Before Boss": world.get_entrance(
                "Forest Temple Lobby -> SFM Forest Temple Entrance Ledge"
            ),
            "Volvagia Boss Room -> Fire Temple Before Boss": world.get_entrance(
                "Fire Temple Lower -> DMC Fire Temple Entrance"
            ),
            "Morpha Boss Room -> Water Temple Before Boss": world.get_entrance(
                "Water Temple Lobby -> Lake Hylia"
            ),
            "Bongo Bongo Boss Room -> Shadow Temple Before Boss": world.get_entrance(
                "Shadow Temple Entryway -> Graveyard Warp Pad Region"
            ),
            "Twinrova Boss Room -> Spirit Temple Before Boss": world.get_entrance(
                "Spirit Temple Lobby -> Desert Colossus From Spirit Lobby"
            ),
        }
        ...
        dungeon_exits = {
            "Deku Tree Lobby -> KF Outside Deku Tree": world.get_entrance(
                "Queen Gohma Boss Room -> KF Outside Deku Tree"
            ),
            "Dodongos Cavern Beginning -> Death Mountain": world.get_entrance(
                "King Dodongo Boss Room -> Death Mountain"
            ),
            "Jabu Jabus Belly Beginning -> Zoras Fountain": world.get_entrance(
                "Barinade Boss Room -> Zoras Fountain"
            ),
            "Forest Temple Lobby -> SFM Forest Temple Entrance Ledge": world.get_entrance(
                "Phantom Ganon Boss Room -> Sacred Forest Meadow"
            ),
            "Fire Temple Lower -> DMC Fire Temple Entrance": world.get_entrance(
                "Volvagia Boss Room -> DMC Central Local"
            ),
            "Water Temple Lobby -> Lake Hylia": world.get_entrance(
                "Morpha Boss Room -> Lake Hylia"
            ),
            "Shadow Temple Entryway -> Graveyard Warp Pad Region": world.get_entrance(
                "Bongo Bongo Boss Room -> Graveyard Warp Pad Region"
            ),
            "Spirit Temple Lobby -> Desert Colossus From Spirit Lobby": world.get_entrance(
                "Twinrova Boss Room -> Desert Colossus"
            ),
        }
        ...
        for blue_warp, boss_door_exit in (
            (
                world.get_entrance("Queen Gohma Boss Room -> KF Outside Deku Tree"),
                world.get_entrance("Queen Gohma Boss Room -> Deku Tree Before Boss"),
            ),
            (
                world.get_entrance("King Dodongo Boss Room -> Death Mountain"),
                world.get_entrance("King Dodongo Boss Room -> Dodongos Cavern Mouth"),
            ),
            (
                world.get_entrance("Barinade Boss Room -> Zoras Fountain"),
                world.get_entrance("Barinade Boss Room -> Jabu Jabus Belly Before Boss"),
            ),
            (
                world.get_entrance("Phantom Ganon Boss Room -> Sacred Forest Meadow"),
                world.get_entrance("Phantom Ganon Boss Room -> Forest Temple Before Boss"),
            ),
            (
                world.get_entrance("Volvagia Boss Room -> DMC Central Local"),
                world.get_entrance("Volvagia Boss Room -> Fire Temple Before Boss"),
            ),
            (
                world.get_entrance("Morpha Boss Room -> Lake Hylia"),
                world.get_entrance("Morpha Boss Room -> Water Temple Before Boss"),
            ),
            (
                world.get_entrance("Bongo Bongo Boss Room -> Graveyard Warp Pad Region"),
                world.get_entrance("Bongo Bongo Boss Room -> Shadow Temple Before Boss"),
            ),
            (
                world.get_entrance("Twinrova Boss Room -> Desert Colossus"),
                world.get_entrance("Twinrova Boss Room -> Spirit Temple Before Boss"),
            ),
        ):
    ...
    for world in worlds:
        for entrance in world.get_shuffled_entrances():
            if entrance.connected_region is None:
                logging.getLogger("").error(
                    "%s was shuffled but still isn't connected to any region [World %d]",
                    entrance,
                    world.id,
                )
            if entrance.replaces is None:
                logging.getLogger("").error(
                    "%s was shuffled but still doesn't replace any entrance [World %d]",
                    entrance,
                    world.id,
                )
        if len(world.get_region("Root Exits").exits) > 8:
            for exit in world.get_region("Root Exits").exits:
                logging.getLogger("").error(
                    "Root Exit: %s, Connected Region: %s", exit, exit.connected_region
                )
            raise RuntimeError(
                "Something went wrong, Root has too many entrances left after shuffling entrances [World %d]"
                % world.id
            )
    ...
    for world in worlds:
        try:
            ...
            raise EntranceShuffleError(
                "Worlds are not valid after shuffling entrances, Reason: %s" % error
            )


def shuffle_one_way_priority_entrances(
    worlds: list[World],
    world: World,
    one_way_priorities: dict[str, tuple[list[str], list[str]]],
    one_way_entrance_pools: dict[str, list[Entrance]],
    one_way_target_entrance_pools: dict[str, list[Entrance]],
    locations_to_ensure_reachable: Iterable[Location],
    complete_itempool: list[Item],
    retry_count: int = 2,
    ...
    while retry_count:
        ...
        try:
            for key, (regions, types) in one_way_priorities.items():
                place_one_way_priority_entrance(
                    worlds,
                    world,
                    key,
                    regions,
            ...
            logging.getLogger("").info(
                "Failed to place all priority one-way entrances for world %d. Will retry %d more times",
                world.id,
                retry_count,
            )
    ...
    if world.settings.custom_seed:
        raise EntranceShuffleError(
            'Entrance placement attempt count exceeded for world %d. Ensure the "Seed" field is empty and retry a few times.'
            % world.id
        )
    if world.settings.distribution_file:
        raise EntranceShuffleError(
            "Entrance placement attempt count exceeded for world %d. Some entrances in the Plandomizer File may have to be changed to create a valid seed. Reach out to Support on Discord for help."
            % world.id
        )
    raise EntranceShuffleError(
        "Entrance placement attempt count exceeded for world %d. Retry a few times or reach out to Support on Discord for help."
        % world.id
    )
...
def shuffle_entrance_pool(
    ...
    target_entrances: list[Entrance],
    locations_to_ensure_reachable: Iterable[Location],
    check_all: bool = False,
    retry_count: int = 20,
    placed_one_way_entrances: Optional[list[tuple[Entrance, Entrance]]] = None,
) -> list[tuple[Entrance, Entrance]]:
    ...
    restrictive_entrances, soft_entrances = split_entrances_by_requirements(
        worlds, entrance_pool, target_entrances
    )
    ...
    while retry_count:
        ...
        try:
            ...
            for entrance, target in rollbacks:
                restore_connections(entrance, target)
            logging.getLogger("").info(
                "Failed to place all entrances in a pool for world %d. Will retry %d more times",
                entrance_pool[0].world.id,
                retry_count,
            )
            logging.getLogger("").info("\t%s" % error)
...
def split_entrances_by_requirements(
    worlds: list[World], entrances_to_split: list[Entrance], assumed_entrances: list[Entrance]
    ...
    entrances_to_disconnect = set(assumed_entrances).union(
        entrance.reverse for entrance in assumed_entrances if entrance.reverse
    )
...
def replace_entrance(
    ...
    try:
        ...
        logging.getLogger("").debug(
            "Failed to connect %s To %s (Reason: %s) [World %d]",
            entrance,
            entrance.connected_region or target.connected_region,
            error,
            entrance.world.id,
        )
        if entrance.connected_region:
...
def place_one_way_priority_entrance(
    worlds: list[World],
    world: World,
    priority_name: str,
    allowed_regions: Container[str],
    ...
    avail_pool = list(
        chain.from_iterable(
            one_way_entrance_pools[t] for t in allowed_types if t in one_way_entrance_pools
        )
    )
    ...
    for entrance in avail_pool:
        ...
        if not entrance.world.shuffle_dungeon_entrances and priority_name == "Nocturne":
            if (
                entrance.type not in ("OverworldOneWay", "WarpSong")
                and entrance.parent_region.name != "Adult Spawn"
            ):
                continue
        for target in one_way_target_entrance_pools[entrance.type]:
            if target.connected_region and target.connected_region.name in allowed_regions:
                if replace_entrance(
                    ...
                    logging.getLogger("").debug(
                        f"Priority placement for {priority_name}: placing {entrance} as {target}"
                    )
                    return
    raise EntranceShuffleError(
        f"Unable to place priority one-way entrance for {priority_name} [World {world.id}]."
    )
...
def shuffle_entrances(
    ...
    for entrance in entrances:
        ...
        if entrance.connected_region is None:
            raise EntranceShuffleError(
                "No more valid entrances to replace with %s in world %d"
                % (entrance, entrance.world.id)
            )


# Check and validate that an entrance is compatible to replace a specific target
def check_entrances_compatibility(
    entrance: Entrance,
    target: Entrance,
    rollbacks: list[tuple[Entrance, Entrance]] = (),
    placed_one_way_entrances: Optional[list[tuple[Entrance, Entrance]]] = None,
    ...
    if (
        entrance.parent_region.get_scene()
        and entrance.parent_region.get_scene() == target.connected_region.get_scene()
    ):
        ...
        try:
            ...
            for rollback in (*rollbacks, *placed_one_way_entrances):
                try:
                    ...
                    if (
                        entrance.type == placed_entrance.type
                        and HintArea.at(placed_entrance.connected_region) == hint_area
                    ):
                        raise EntranceShuffleError(
                            f"Another {entrance.type} entrance already leads to {hint_area}"
                        )
                except HintAreaNotFound:
                    pass
...
def validate_world(
    world: World,
    worlds: list[World],
    entrance_placed: Optional[Entrance],
    locations_to_ensure_reachable: Iterable[Location],
    itempool: list[Item],
    placed_one_way_entrances: Optional[list[tuple[Entrance, Entrance]]] = None,
) -> None:
    ...
    for entrance in world.get_shufflable_entrances():
        if entrance.shuffled:
            if entrance.replaces:
                if entrance.replaces.name in CHILD_FORBIDDEN and not entrance_unreachable_as(
                    entrance, "child", already_checked=[entrance.replaces.reverse]
                ):
                    raise EntranceShuffleError(
                        "%s is replaced by an entrance with a potential child access"
                        % entrance.replaces.name
                    )
                elif entrance.replaces.name in ADULT_FORBIDDEN and not entrance_unreachable_as(
                    entrance, "adult", already_checked=[entrance.replaces.reverse]
                ):
                    raise EntranceShuffleError(
                        "%s is replaced by an entrance with a potential adult access"
                        % entrance.replaces.name
                    )
        else:
            if entrance.name in CHILD_FORBIDDEN and not entrance_unreachable_as(
                entrance, "child", already_checked=[entrance.reverse]
            ):
                raise EntranceShuffleError("%s is potentially accessible as child" % entrance.name)
            elif entrance.name in ADULT_FORBIDDEN and not entrance_unreachable_as(
                entrance, "adult", already_checked=[entrance.reverse]
            ):
    ...
    if (
        world.shuffle_interior_entrances
        and (
            (
                world.dungeon_rewards_hinted
                and (
                    world.mixed_pools_bosses
                    or world.settings.shuffle_dungeon_rewards
                    in ("regional", "overworld", "anywhere")
                )
            )
            or any(hint_type in world.settings.misc_hints for hint_type in misc_item_hint_table)
        ...
        potion_front_entrance = get_entrance_replacing(
            world.get_region("Kak Potion Shop Front"), "Kakariko Village -> Kak Potion Shop Front"
        )
        potion_back_entrance = get_entrance_replacing(
            world.get_region("Kak Potion Shop Back"), "Kak Backyard -> Kak Potion Shop Back"
        )
        if (
            potion_front_entrance is not None
            and potion_back_entrance is not None
            and not same_hint_area(potion_front_entrance, potion_back_entrance)
        ):
        ...
        if world.settings.shuffle_cows:
            impas_front_entrance = get_entrance_replacing(
                world.get_region("Kak Impas House"), "Kakariko Village -> Kak Impas House"
            )
            impas_back_entrance = get_entrance_replacing(
                world.get_region("Kak Impas House Back"), "Kak Impas Ledge -> Kak Impas House Back"
            )
            if (
                impas_front_entrance is not None
                and impas_back_entrance is not None
                and not same_hint_area(impas_front_entrance, impas_back_entrance)
            ):
                raise EntranceShuffleError(
                    "Kak Impas House entrances are not in the same hint area"
                )

    if (
        world.shuffle_special_interior_entrances
        or world.settings.shuffle_overworld_entrances
        or world.settings.spawn_positions
    ) and (
        entrance_placed is None
        or entrance_placed.type
        in (
            "SpecialInterior",
            "Hideout",
            "Overworld",
        ...
        if not any(
            no_items_search.can_reach(world.get_region(region)) for region in valid_starting_regions
        ):
        ...
        time_travel_search = Search.with_items(
            [w.state for w in worlds], [ItemFactory("Time Travel", world=w) for w in worlds]
        )

        if not (
            any(
                region
                for region in time_travel_search.reachable_regions("child")
                if region.time_passes and region.world == world
            )
            and any(
                region
                for region in time_travel_search.reachable_regions("adult")
                if region.time_passes and region.world == world
            )
        ):
        ...
        if world.settings.starting_age == "child" and not time_travel_search.can_reach(
            world.get_region("Temple of Time"), age="adult"
        ):
            raise EntranceShuffleError("Path to Temple of Time as adult is not guaranteed")
        elif world.settings.starting_age == "adult" and not time_travel_search.can_reach(
            world.get_region("Temple of Time"), age="child"
        ):
        ...
        try:
            ...
            for idx2 in range(idx1):
                try:
                    ...
                    if entrance1.type == entrance2.type and hint_area1 == HintArea.at(
                        entrance2.connected_region
                    ):
                        raise EntranceShuffleError(
                            f"Multiple {entrance1.type} entrances lead to {hint_area1}"
                        )
                except HintAreaNotFound:
                    pass
...
def entrance_unreachable_as(
    entrance: Entrance, age: str, already_checked: Optional[list[Entrance]] = None
) -> bool:
...
def get_entrance_replacing(region: Region, entrance_name: str) -> Optional[Entrance]:
    ...
    try:
        return next(
            filter(
                lambda entrance: entrance.replaces
                and entrance.replaces.name == entrance_name
                and entrance.parent_region
                and entrance.parent_region.name != "Root Exits"
                and entrance.type
                not in ("OverworldOneWay", "OwlDrop", "Spawn", "WarpSong", "BlueWarp"),
                region.entrances,
            )
        )
...
def confirm_replacement(entrance: Entrance, target_entrance: Entrance) -> None:
    ...
    logging.getLogger("").debug(
        "Connected %s To %s [World %d]", entrance, entrance.connected_region, entrance.world.id
    )
    if entrance.reverse:
        replaced_reverse = target_entrance.replaces.reverse
        delete_target_entrance(entrance.reverse.assumed)
        logging.getLogger("").debug(
            "Connected %s To %s [World %d]",
            replaced_reverse,
            replaced_reverse.connected_region,
            replaced_reverse.world.id,
        )
