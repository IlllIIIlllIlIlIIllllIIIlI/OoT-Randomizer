...
z64_actor_t* Obj_Mure3_RupeeCircle_DropRupee(z64_actor_t* this, z64_xyzf_t* pos,
                                             uint16_t params, uint32_t index) {
	xflag_t flag = {0};
	...
	if (get_newflag_override(&flag).key.all) {
		...
		z64_actor_t* spawned =
			(z64_actor_t*)z64_Item_DropCollectible2(&z64_game, pos, params);
