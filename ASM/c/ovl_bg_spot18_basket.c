...
z64_actor_t* BgSpot18Basket_BombDropHook(z64_actor_t* this, z64_xyzf_t* pos,
                                         uint32_t index) {
	xflag_t flag = {0};
	...
	if (get_newflag_override(&flag).key.all) {
		...
		z64_actor_t* spawned =
			(z64_actor_t*)z64_Item_DropCollectible(&z64_game, pos, 0);
...
z64_actor_t* BgSpot18Basket_RupeeDropHook(z64_actor_t* this, z64_xyzf_t* pos,
                                          uint32_t index) {
	xflag_t flag = {0};
	ActorAdditionalData* extras = Actor_GetAdditionalData(this);
...
z64_actor_t* BgSpot18Basket_Heartpiecerupee_DropHook(z64_actor_t* this,
                                                     z64_xyzf_t* pos,
                                                     uint16_t params) {
	xflag_t flag = {0};
	ActorAdditionalData* extras = Actor_GetAdditionalData(this);
