...
texture_t texture_table[TEXTURE_ID_MAX] = {
	...
	[TEXTURE_ID_SMALLCRATE_BOSSKEY] = {.textureID =
						   TEXTURE_ID_SMALLCRATE_BOSSKEY},

	[TEXTURE_ID_CHEST_FRONT_GILDED] = {.textureID =
						   TEXTURE_ID_CHEST_FRONT_GILDED},
	[TEXTURE_ID_CHEST_BASE_GILDED] = {.textureID =
						  TEXTURE_ID_CHEST_BASE_GILDED},
	[TEXTURE_ID_CHEST_FRONT_SILVER] = {.textureID =
						   TEXTURE_ID_CHEST_FRONT_SILVER},
	[TEXTURE_ID_CHEST_BASE_SILVER] = {.textureID =
						  TEXTURE_ID_CHEST_BASE_SILVER},
	[TEXTURE_ID_CHEST_FRONT_SKULL] = {.textureID =
						  TEXTURE_ID_CHEST_FRONT_SKULL},
	[TEXTURE_ID_CHEST_BASE_SKULL] = {.textureID = TEXTURE_ID_CHEST_BASE_SKULL},

	[TEXTURE_ID_CHEST_FRONT_HEART] = {.textureID =
						  TEXTURE_ID_CHEST_FRONT_HEART},
