...
typedef enum {
	...
	/*  1 */ BIG_ROOM_CLEAR_CHEST, // appear on room clear, store temp clear as
	                               // permanent clear
	/*  2 */ GOLD_CHEST, // boss key chest, different look, same as BROWN_CHEST
	                     // otherwise
	...
	/*  7 */ SMALL_ROOM_CLEAR_CHEST, // use room clear, store temp clear as perm
	                                 // clear
	/*  8 */ SMALL_FALLING_CHEST, // falling, appear on switch flag set
	/*  9 */ TYPE_9_CHEST, // big, has something more to do with player and
	                       // message context?
