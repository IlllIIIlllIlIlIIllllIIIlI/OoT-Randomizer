...
/**
 * Returns a pseudo-random floating-point number between 0.0f and 1.0f, by
 * generating the next integer and masking it to an IEEE-754 compliant
 * floating-point number between 1.0f and 2.0f, returning the result
 * subtract 1.0f.
 */
...
/**
 * Returns a pseudo-random floating-point number between -0.5f and 0.5f by the
 * same manner in which Rand_ZeroOne generates its result.
 */
