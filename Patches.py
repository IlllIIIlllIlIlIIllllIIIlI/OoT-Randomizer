...
from Hints import (
    GossipText,
    HintArea,
    write_gossip_stone_hints,
    build_altar_hints,
    build_ganon_text,
    build_misc_item_hints,
    build_misc_location_hints,
    get_simple_hint_no_prefix,
    get_item_generic_name,
)
...
def patch_rom(spoiler: Spoiler, world: World, rom: Rom) -> Rom:
    ...
    zobj_imports = (
        ...
        (
            "object_gi_skeythieves",
            data_path("items/SmallThieves.zobj"),
            0x1A0,
        ),  # Small Key (Thieves)
        ...
        (
            "object_gi_cbutton",
            data_path("items/C_Button_Horizontal.zobj"),
            0x1A9,
        ),  # C button Horizontal
        (
            "object_gi_cbutton",
            data_path("items/C_Button_Vertical.zobj"),
            0x1AA,
        ),  # C button Vertical
    )
    ...
    crate_textures = [
        (
            ...
            2048,
            rgba16_patch,
            "textures/pot/pot_gold_rgba16_patch.bin",
        ),
        (
            2,
            "texture_pot_key",
            ...
            2048,
            rgba16_patch,
            "textures/pot/pot_key_rgba16_patch.bin",
        ),
        (
            3,
            "texture_pot_bosskey",
            ...
            2048,
            rgba16_patch,
            "textures/pot/pot_bosskey_rgba16_patch.bin",
        ),
        (
            4,
            "texture_pot_skull",
            ...
            2048,
            rgba16_patch,
            "textures/pot/pot_skull_rgba16_patch.bin",
        ),
        ...
        (
            ...
            0x018B6000,
            4096,
            ci4_rgba16patch_to_ci8,
            "textures/crate/crate_gold_rgba16_patch.bin",
        ),
        (
            7,
            "texture_crate_key",
            ...
            4096,
            ci4_rgba16patch_to_ci8,
            "textures/crate/crate_key_rgba16_patch.bin",
        ),
        (
            8,
            "texture_crate_skull",
            ...
            4096,
            ci4_rgba16patch_to_ci8,
            "textures/crate/crate_skull_rgba16_patch.bin",
        ),
        (
            9,
            ...
            4096,
            ci4_rgba16patch_to_ci8,
            "textures/crate/crate_bosskey_rgba16_patch.bin",
        ),
        (
            10,
            "texture_smallcrate_gold",
            0xF7ECA0,
            None,
            2048,
            rgba16_patch,
            "textures/crate/smallcrate_gold_rgba16_patch.bin",
        ),
        (
            11,
            "texture_smallcrate_key",
            0xF7ECA0,
            None,
            2048,
            rgba16_patch,
            "textures/crate/smallcrate_key_rgba16_patch.bin",
        ),
        (
            12,
            "texture_smallcrate_skull",
            0xF7ECA0,
            None,
            2048,
            rgba16_patch,
            "textures/crate/smallcrate_skull_rgba16_patch.bin",
        ),
        (
            13,
            "texture_smallcrate_bosskey",
            0xF7ECA0,
            None,
            2048,
            rgba16_patch,
            "textures/crate/smallcrate_bosskey_rgba16_patch.bin",
        ),
        (
            18,
            "texture_chest_front_gilded",
            0xFEC798,
            None,
            4096,
            rgba16_patch,
            "textures/chest/chest_front_gilded_rgba16_patch.bin",
        ),
        (
            19,
            "texture_chest_base_gilded",
            0xFED798,
            None,
            2048,
            rgba16_patch,
            "textures/chest/chest_base_gilded_rgba16_patch.bin",
        ),
        (
            20,
            "texture_chest_front_silver",
            0xFEC798,
            None,
            4096,
            rgba16_patch,
            "textures/chest/chest_front_silver_rgba16_patch.bin",
        ),
        (
            21,
            "texture_chest_base_silver",
            0xFED798,
            None,
            2048,
            rgba16_patch,
            "textures/chest/chest_base_silver_rgba16_patch.bin",
        ),
        (
            22,
            "texture_chest_front_skull",
            0xFEC798,
            None,
            4096,
            rgba16_patch,
            "textures/chest/chest_front_skull_rgba16_patch.bin",
        ),
        (
            23,
            "texture_chest_base_skull",
            0xFED798,
            None,
            2048,
            rgba16_patch,
            "textures/chest/chest_base_skull_rgba16_patch.bin",
        ),
        (
            24,
            "texture_chest_front_heart",
            0xFEC798,
            None,
            4096,
            rgba16_patch,
            "textures/chest/chest_front_heart_rgba16_patch.bin",
        ),
        (
            25,
            "texture_chest_base_heart",
            0xFED798,
            None,
            2048,
            rgba16_patch,
            "textures/chest/chest_base_heart_rgba16_patch.bin",
        ),
        (
            26,
            "texture_pot_side_heart",
            0x01738000,
            None,
            2048,
            rgba16_patch,
            "textures/pot/pot_side_heart_rgba16_patch.bin",
        ),
        (
            27,
            "texture_pot_top_heart",
            0x01739000,
            None,
            256,
            rgba16_patch,
            "textures/pot/pot_top_heart_rgba16_patch.bin",
        ),
        (
            28,
            "texture_crate_heart",
            ...
            4096,
            ci4_rgba16patch_to_ci8,
            "textures/crate/crate_heart_rgba16_patch.bin",
        ),
        (
            29,
            "texture_smallcrate_heart",
            0xF7ECA0,
            None,
            2048,
            rgba16_patch,
            "textures/crate/smallcrate_heart_rgba16_patch.bin",
        ),
    ]
    ...
    for (
        ...
        texture_data = func(
            ...
            rom_address_palette,
            size,
            data_path(patch_file) if patch_file else None,
        )
    ...
    songs_as_items = (
        ...
        or any(
            name in song_list and record.count
    ...
    rom.write_byte(
        0xBB84B7, 0xFF
    )  # Set glowing orb above magic arrow to be small sized immediately
    ...
    )  # re-order the carpenter's path
    rom.write_byte(0x1FF93D0, 0x06)  # set the path points to 6
    rom.write_bytes(
        0x20160B6, [0x01, 0x8D, 0x00, 0x11, 0x01, 0x6C]
    )  # set the carpenter's start position
    ...
    def set_entrance_updates(entrances: Iterable[Entrance]) -> None:
        for entrance in entrances:
            ...
            if "savewarp_addresses" in replaced_entrance and entrance.reverse:
                if entrance.parent_region.savewarp:
                    ...
                    while "savewarp_fallback" in savewarp.data:
                        parents = list(
                            filter(lambda parent: parent.reverse, savewarp.parent_region.entrances)
                        )
                        if len(parents) == 0:
            ...
            for address in new_entrance.get("addresses", []):
                rom.write_int16(
                    address, replaced_entrance.get("child_index", replaced_entrance["index"])
                )
            ...
            if entrance.type == "BlueWarp" and replaced_entrance["index"] < 0x1000:
                ...
                exit_updates.append(
                    (
                        new_entrance["index"],
                        replaced_entrance.get("child_index", replaced_entrance["index"]),
                    )
                )
                exit_updates.append(
                    (
                        new_entrance["index"] + 1,
                        replaced_entrance.get("child_index", replaced_entrance["index"]) + 1,
                    )
                )
    ...
    if world.disable_trade_revert:
        ...
        rom.write_int16s(
            0xB6D460, [0x0030, 0x0035, 0x0036]
        )  # Change trade items revert table to prevent all reverts

    if world.settings.adult_trade_shuffle or world.settings.item_pool_value in (
        "plentiful",
        "ludicrous",
    ):
    ...
    if world.settings.shuffle_overworld_entrances:
        ...
        for k in (0x028A, 0x028E, 0x0292):  # Southern, Western, Eastern Gates
            exit_table[0x01F9] += exit_table[
                k
            ]  # Hyrule Field entrance from Lon Lon Ranch (main land entrance)
            del exit_table[k]
    ...
    set_entrance_updates(
        ...
        if entrance.shuffled or (patch_blue_warps and entrance.type == "BlueWarp")
    )
    ...
    # Initial Save Data
    if (
        not world.settings.useful_cutscenes
        and "Forest Temple" not in world.settings.dungeon_shortcuts
    ):
        save_context.write_bits(
            0x00D4 + 0x03 * 0x1C + 0x04 + 0x0, 0x08
        )  # Forest Temple switch flag (Poe Sisters cutscene)

    if "Deku Tree" in world.settings.dungeon_shortcuts:
        # Deku Tree, flags are the same between vanilla/MQ
        save_context.write_permanent_flag(
            Scenes.DEKU_TREE, FlagType.SWITCH, 0x1, 0x01
        )  # Deku Block down
        save_context.write_permanent_flag(
            Scenes.DEKU_TREE, FlagType.CLEAR, 0x2, 0x02
        )  # Deku 231/312
        save_context.write_permanent_flag(
            Scenes.DEKU_TREE, FlagType.SWITCH, 0x3, 0x20
        )  # Deku 1st Web
        save_context.write_permanent_flag(
            Scenes.DEKU_TREE, FlagType.SWITCH, 0x3, 0x40
        )  # Deku 2nd Web

    if "Dodongos Cavern" in world.settings.dungeon_shortcuts:
        # Dodongo's Cavern, flags are the same between vanilla/MQ
        save_context.write_permanent_flag(
            Scenes.DODONGOS_CAVERN, FlagType.SWITCH, 0x3, 0x80
        )  # DC Entrance Mud Wall
        save_context.write_permanent_flag(
            Scenes.DODONGOS_CAVERN, FlagType.SWITCH, 0x0, 0x04
        )  # DC Mouth
        # Extra permanent flag in MQ for the child route
        if world.dungeon_mq["Dodongos Cavern"]:
            save_context.write_permanent_flag(
                Scenes.DODONGOS_CAVERN, FlagType.SWITCH, 0x0, 0x02
            )  # Armos wall switch
    ...
    if "Jabu Jabus Belly" in world.settings.dungeon_shortcuts:
        ...
        if not world.dungeon_mq["Jabu Jabus Belly"]:
            save_context.write_permanent_flag(
                Scenes.JABU_JABU, FlagType.SWITCH, 0x0, 0x20
            )  # Jabu Pathway down
        else:
            save_context.write_permanent_flag(
                Scenes.JABU_JABU, FlagType.SWITCH, 0x1, 0x20
            )  # Jabu Lobby Slingshot Door open
            save_context.write_permanent_flag(
                Scenes.JABU_JABU, FlagType.SWITCH, 0x0, 0x20
            )  # Jabu Pathway down
            save_context.write_permanent_flag(
                Scenes.JABU_JABU, FlagType.CLEAR, 0x2, 0x01
            )  # Jabu Red Slimy Thing defeated
            save_context.write_permanent_flag(
                Scenes.JABU_JABU, FlagType.SWITCH, 0x2, 0x08
            )  # Jabu Red Slimy Thing not in front of boss lobby
            save_context.write_permanent_flag(
                Scenes.JABU_JABU, FlagType.SWITCH, 0x1, 0x10
            )  # Jabu Boss Door Switch Activated

    if "Forest Temple" in world.settings.dungeon_shortcuts:
        # Forest, flags are the same between vanilla/MQ
        save_context.write_permanent_flag(
            Scenes.FOREST_TEMPLE, FlagType.SWITCH, 0x0, 0x10
        )  # Forest Elevator up
        save_context.write_permanent_flag(
            Scenes.FOREST_TEMPLE, FlagType.SWITCH, 0x1, 0x01 + 0x02 + 0x04
        )  # Forest Basement Puzzle Done

    if "Fire Temple" in world.settings.dungeon_shortcuts:
        # Fire, flags are the same between vanilla/MQ
        save_context.write_permanent_flag(
            Scenes.FIRE_TEMPLE, FlagType.SWITCH, 0x2, 0x40
        )  # Fire Pillar down
    ...
    if "Spirit Temple" in world.settings.dungeon_shortcuts:
        ...
        if not world.dungeon_mq["Spirit Temple"]:
            save_context.write_permanent_flag(
                Scenes.SPIRIT_TEMPLE, FlagType.SWITCH, 0x1, 0x80
            )  # Spirit Chains
            save_context.write_permanent_flag(
                Scenes.SPIRIT_TEMPLE, FlagType.SWITCH, 0x2, 0x02 + 0x08 + 0x10
            )  # Spirit main room elevator (N block, Rusted Switch, E block)
            save_context.write_permanent_flag(
                Scenes.SPIRIT_TEMPLE, FlagType.SWITCH, 0x3, 0x10
            )  # Spirit Face
        else:
            save_context.write_permanent_flag(
                Scenes.SPIRIT_TEMPLE, FlagType.SWITCH, 0x2, 0x10
            )  # Spirit Bombchu Boulder
            save_context.write_permanent_flag(
                Scenes.SPIRIT_TEMPLE, FlagType.SWITCH, 0x2, 0x02
            )  # Spirit Silver Block
            save_context.write_permanent_flag(
                Scenes.SPIRIT_TEMPLE, FlagType.SWITCH, 0x1, 0x80
            )  # Spirit Chains
    ...
    if "Shadow Temple" in world.settings.dungeon_shortcuts:
        ...
        if not world.dungeon_mq["Shadow Temple"]:
            save_context.write_permanent_flag(
                Scenes.SHADOW_TEMPLE, FlagType.SWITCH, 0x0, 0x08
            )  # Shadow Truthspinner
            save_context.write_permanent_flag(
                Scenes.SHADOW_TEMPLE, FlagType.SWITCH, 0x0, 0x20
            )  # Shadow Boat Block
            save_context.write_permanent_flag(
                Scenes.SHADOW_TEMPLE, FlagType.SWITCH, 0x1, 0x01
            )  # Shadow Bird Bridge
        else:
            save_context.write_permanent_flag(
                Scenes.SHADOW_TEMPLE, FlagType.SWITCH, 0x2, 0x08
            )  # Shadow Truthspinner
            save_context.write_permanent_flag(
                Scenes.SHADOW_TEMPLE, FlagType.SWITCH, 0x3, 0x20
            )  # Shadow Fire Arrow Platform
            save_context.write_permanent_flag(
                Scenes.SHADOW_TEMPLE, FlagType.SWITCH, 0x3, 0x80
            )  # Shadow Spinning Blades room Skulltulas defeated
            save_context.write_permanent_flag(
                Scenes.SHADOW_TEMPLE, FlagType.CLEAR, 0x3, 0x40
            )  # Shadow Spinning Blades room Skulltulas defeated
            save_context.write_permanent_flag(
                Scenes.SHADOW_TEMPLE, FlagType.SWITCH, 0x0, 0x20
            )  # Shadow Boat Block
    ...
    if world.region_has_shortcuts("King Dodongo Boss Room"):
        save_context.write_permanent_flag(
            Scenes.KING_DODONGO_LOBBY, FlagType.SWITCH, 0x3, 0x02
        )  # DC Boss Floor

    set_spirit_shortcut_actors(
        rom
    )  # Change elevator starting position to avoid waiting a half cycle from the temple entrance

    if world.settings.plant_beans:
        save_context.write_permanent_flag(
            Scenes.GRAVEYARD, FlagType.SWITCH, 0x3, 0x08
        )  # Plant Graveyard bean
        save_context.write_permanent_flag(
            Scenes.ZORAS_RIVER, FlagType.SWITCH, 0x3, 0x08
        )  # Plant Zora's River bean
        save_context.write_permanent_flag(
            Scenes.KOKIRI_FOREST, FlagType.SWITCH, 0x2, 0x02
        )  # Plant Kokiri Forest bean
        save_context.write_permanent_flag(
            Scenes.LAKE_HYLIA, FlagType.SWITCH, 0x3, 0x02
        )  # Plant Lake Hylia bean
        save_context.write_permanent_flag(
            Scenes.GERUDO_VALLEY, FlagType.SWITCH, 0x3, 0x08
        )  # Plant Gerudo Valley bean
        save_context.write_permanent_flag(
            Scenes.LOST_WOODS, FlagType.SWITCH, 0x3, 0x10
        )  # Plant Lost Woods bridge bean
        save_context.write_permanent_flag(
            Scenes.LOST_WOODS, FlagType.SWITCH, 0x1, 0x04
        )  # Plant Lost Woods theater bean
        save_context.write_permanent_flag(
            Scenes.DESERT_COLOSSUS, FlagType.SWITCH, 0x0, 0x1
        )  # Plant Desert Colossus bean
        save_context.write_permanent_flag(
            Scenes.DEATH_MOUNTAIN_TRAIL, FlagType.SWITCH, 0x3, 0x40
        )  # Plant Death Mountain Trail bean
        save_context.write_permanent_flag(
            Scenes.DEATH_MOUNTAIN_CRATER, FlagType.SWITCH, 0x3, 0x08
        )  # Plant Death Mountain Crater bean

    save_context.write_bits(
        0x00D4 + 0x05 * 0x1C + 0x04 + 0x1, 0x01
    )  # Water temple switch flag (Ruto)
    save_context.write_bits(
        0x00D4 + 0x51 * 0x1C + 0x04 + 0x2, 0x08
    )  # Hyrule Field switch flag (Owl)
    save_context.write_bits(
        0x00D4 + 0x55 * 0x1C + 0x04 + 0x0, 0x80
    )  # Kokiri Forest switch flag (Owl)
    save_context.write_bits(
        0x00D4 + 0x56 * 0x1C + 0x04 + 0x2, 0x40
    )  # Sacred Forest Meadow switch flag (Owl)
    ...
    save_context.write_bits(
        0x00D4 + 0x5C * 0x1C + 0x04 + 0x0, 0x80
    )  # Desert Colossus switch flag (Owl)
    save_context.write_bits(
        0x00D4 + 0x5F * 0x1C + 0x04 + 0x3, 0x20
    )  # Hyrule Castle switch flag (Owl)
    ...
    if not world.settings.adult_trade_shuffle and len(world.settings.adult_trade_start) > 0:
        ...
        save_context.write_permanent_flags(
            Scenes.GORON_CITY, FlagType.UNK00, calculate_traded_flags(world)
        )
    ...
    if world.skip_child_zelda:
        if all(
            trade_item not in world.settings.shuffle_child_trade
            for trade_item in ("Weird Egg", "Chicken")
        ):
        ...
        save_context.write_bits(
            0x00D4 + 0x5F * 0x1C + 0x04 + 0x3, 0x10
        )  # "Moved crates to access the courtyard"
    if world.skip_child_zelda or "Zeldas Letter" in world.distribution.starting_items.keys():
        ...
        if world.settings.complete_mask_quest:
            ...
            save_context.write_bits(
                0x0EF6, 0x8F
            )  # "Sold Masks & Unlocked Masks" / "Obtained Mask of Truth"
    ...
    if world.settings.no_escape_sequence:
        rom.write_bytes(
            0xD82A12, [0x05, 0x17]
        )  # Sets exit from Ganondorf fight to entrance to Ganon fight
    ...
    if world.settings.gerudo_fortress == "open":
        ...
        save_context.write_bits(
            0x00D4 + 0x0C * 0x1C + 0x04 + 0x1, 0x0F
        )  # Thieves' Hideout switch flags (started all fights)
        save_context.write_bits(
            0x00D4 + 0x0C * 0x1C + 0x04 + 0x2, 0x01
        )  # Thieves' Hideout switch flags (heard yells/unlocked doors)
        save_context.write_bits(
            0x00D4 + 0x0C * 0x1C + 0x04 + 0x3, 0xFE
        )  # Thieves' Hideout switch flags (heard yells/unlocked doors)
        save_context.write_bits(
            0x00D4 + 0x0C * 0x1C + 0x0C + 0x2, 0xD4
        )  # Thieves' Hideout collection flags (picked up keys, marks fights finished as well)
    elif world.settings.gerudo_fortress == "fast":
        save_context.write_bits(0x0EE7, 0x0E)  # Free 3 carpenters
        save_context.write_bits(
            0x00D4 + 0x0C * 0x1C + 0x04 + 0x1, 0x0D
        )  # Thieves' Hideout switch flags (started all fights)
        save_context.write_bits(
            0x00D4 + 0x0C * 0x1C + 0x04 + 0x2, 0x01
        )  # Thieves' Hideout switch flags (heard yells/unlocked doors)
        save_context.write_bits(
            0x00D4 + 0x0C * 0x1C + 0x04 + 0x3, 0xDC
        )  # Thieves' Hideout switch flags (heard yells/unlocked doors)
        save_context.write_bits(
            0x00D4 + 0x0C * 0x1C + 0x0C + 0x2, 0xC4
        )  # Thieves' Hideout collection flags (picked up keys, marks fights finished as well)
    ...
    if world.settings.starting_age == "adult":
        ...
        save_context.addresses["equip_items"][
            "master_sword"
        ].value = True  # Equip Master Sword by default
        save_context.addresses["equip_items"][
            "kokiri_tunic"
        ].value = True  # Equip Kokiri Tunic & Kokiri Boots by default
        save_context.addresses["equip_items"][
            "kokiri_boots"
        ].value = True  # (to avoid issues when going back child for the first time)
        save_context.write_byte(
            0x0F33, 0x00
        )  # Unset Swordless Flag (to avoid issues with sword getting unequipped)
    ...
    rom.write_int32s(
        0x28E3070, [0x028E4000, 0x0290D7B0, bazaar_room_file.start, bazaar_room_file.end]
    )  # room list
    ...
    # update dialogue
    new_message = (
        "\x08Hey, young man. What's happening \x01today? If you have a \x05\x41Poe\x05\x40, I will \x01buy it.\x04\x1aIf you earn \x05\x41%d points\x05\x40, you'll\x01be a happy man! Heh heh.\x04\x08Your card now has \x05\x45\x1e\x01 \x05\x40points.\x01Come back again!\x01Heh heh heh!\x02"
        % poe_points
    )
    update_message_by_id(messages, 0x70F5, new_message)
    if world.settings.big_poe_count != 10:
        new_message = (
            "\x1aOh, you brought a Poe today!\x04\x1aHmmmm!\x04\x1aVery interesting!\x01This is a \x05\x41Big Poe\x05\x40!\x04\x1aI'll buy it for \x05\x4150 Rupees\x05\x40.\x04On top of that, I'll put \x05\x41100\x01points \x05\x40on your card.\x04\x1aIf you earn \x05\x41%d points\x05\x40, you'll\x01be a happy man! Heh heh."
            % poe_points
        )
        update_message_by_id(messages, 0x70F7, new_message)
        new_message = (
            "\x1aWait a minute! WOW!\x04\x1aYou have earned \x05\x41%d points\x05\x40!\x04\x1aYoung man, you are a genuine\x01\x05\x41Ghost Hunter\x05\x40!\x04\x1aIs that what you expected me to\x01say? Heh heh heh!\x04\x1aBecause of you, I have extra\x01inventory of \x05\x41Big Poes\x05\x40, so this will\x01be the last time I can buy a \x01ghost.\x04\x1aYou're thinking about what I \x01promised would happen when you\x01earned %d points. Heh heh.\x04\x1aDon't worry, I didn't forget.\x01Just take this."
    ...
    new_message = (
        "\x08What should I do!?\x01My \x05\x41Cuccos\x05\x40 have all flown away!\x04You, little boy, please!\x01Please gather at least \x05\x41%d Cuccos\x05\x40\x01for me.\x02"
        % world.settings.chicken_count
    )
    ...
    if location is not None and location.item is not None:  # TODO make actor invisible if no item?
        ...
        rom.write_bytes(
            rom.sym("CFG_BIGOCTO_OVERRIDE_KEY"), override_key_struct.pack(scene, type, default)
        )
    ...
    if world.settings.skip_some_minigame_phases:
        save_context.write_bits(
            0x00D4 + 0x48 * 0x1C + 0x08 + 0x3, 0x10
        )  # Beat First Dampe Race (& Chest Spawned)
    ...
    if world.settings.shuffle_freestanding_items:
        ...
        actor_override_locations = [
            location
            for location in world.get_locations()
            if location.disabled == DisableType.ENABLED and location.type == "ActorOverride"
        ]
        # rupeetower_locations = [
        #     location
        #     for location in world.get_locations()
        #     if location.disabled == DisableType.ENABLED and location.type == "RupeeTower"
        # ]
    ...
    if world.shuffle_silver_rupees:
        ...
        if world.dungeon_mq[
            "Dodongos Cavern"
        ]:  # Patch DC MQ Staircase Transition Actor to use permanent switch flag 0x1F
            rom.write_byte(0x1F12190 + 15, 0x9F)

        if world.dungeon_mq[
            "Spirit Temple"
        ]:  # Patch Spirit MQ Lobby front right chest to use permanent switch flag 0x1F
    ...
    xflag_scene_table, xflag_room_table, xflag_room_blob, max_bit = build_xflag_tables(
        xflags_tables
    )
    ...
    update_message_by_id(
        messages,
        shop_items[0x001C].description_message,
        "\x08\x05\x41Bombchu  (10 pieces)  99 Rupees\x01\x05\x40This looks like a toy mouse, but\x01it's actually a self-propelled time\x01bomb!\x09\x0a",
    )
    update_message_by_id(
        messages,
        shop_items[0x001C].purchase_message,
        "\x08Bombchu  10 pieces   99 Rupees\x09\x01\x01\x1b\x05\x42Buy\x01Don't buy\x05\x40",
    )
    ...
    update_message_by_id(
        messages,
        0x80B5,
        "\x08\x05\x43Blue Potion 100 Rupees\x01\x05\x40If you drink this, you will\x01recover your life energy and magic.\x09\x0a",
        0x03,
    )
    update_message_by_id(
        messages,
        0x80BE,
        "\x08Blue Potion 100 Rupees\x01\x01\x1b\x05\x42Buy\x01Don't buy\x05\x40",
        0x03,
    )
    ...
    shop_locations = [
        location
        for location in world.get_region("KF Kokiri Shop").locations
        if location.type == "Shop"
    ]  # Need to filter because of the freestanding item in KF Shop
    ...
    # kakariko bazaar
    shop_objs = place_shop_items(
        rom, world, shop_items, messages, world.get_region("Kak Bazaar").locations
    )
    ...
    # castle town bazaar
    shop_objs = place_shop_items(
        rom, world, shop_items, messages, world.get_region("Market Bazaar").locations
    )
    shop_objs |= {0x005B, 0x00B2, 0x00C5, 0x0107, 0x00C9, 0x016B}  # Shop objects
    ...
    # goron shop
    shop_objs = place_shop_items(
        rom, world, shop_items, messages, world.get_region("GC Shop").locations
    )
    ...
    # zora shop
    shop_objs = place_shop_items(
        rom, world, shop_items, messages, world.get_region("ZD Shop").locations
    )
    ...
    shop_objs = place_shop_items(
        rom, world, shop_items, messages, world.get_region("Kak Potion Shop Front").locations
    )
    ...
    # market potion shop
    shop_objs = place_shop_items(
        rom, world, shop_items, messages, world.get_region("Market Potion Shop").locations
    )
    ...
    # bombchu shop
    shop_objs = place_shop_items(
        rom, world, shop_items, messages, world.get_region("Market Bombchu Shop").locations
    )
    ...
    shop_objs = place_shop_items(
        ...
        list(
            filter(
                lambda loc: loc.type == "MaskShop",
                world.get_region("Market Mask Shop Storefront").locations,
            )
        ),
    )
    ...
    # Scrub text stuff.
    def update_scrub_text(
        message: bytearray,
        text_replacement: list[str],
        default_price: int,
        price: int,
        ...
        if default_price != price:
            message = message.replace(
                ("%d Rupees" % default_price).encode(), ("%d Rupees" % price).encode()
            )
    ...
    if world.settings.shuffle_scrubs == "off":
        ...
        for scrub_item, default_price, text_id, text_replacement in business_scrubs:
            if scrub_item not in single_item_scrubs.keys():
                continue
            scrub_message_dict[text_id] = update_scrub_text(
                get_message_by_id(messages, text_id).raw_text,
                text_replacement,
                default_price,
                default_price,
            )
    ...
    if world.settings.shuffle_cows:
        ...
        rom.write_bytes(
            0x33650CA, [0xFE, 0xD3, 0x00, 0x00, 0x00, 0x6E, 0x00, 0x00, 0x4A, 0x34]
        )  # LLR Tower right cow
    ...
    if world.settings.shuffle_beans:
        ...
        if "unique_merchants" not in world.settings.misc_hints:
            update_message_by_id(
                messages,
                0x405E,
                "\x1aChomp chomp chomp...\x01We have... \x05\x41a mysterious item\x05\x40! \x01Do you want it...huh? Huh?\x04\x05\x41\x0860 Rupees\x05\x40 and it's yours!\x01Keyahahah!\x01\x1b\x05\x42Yes\x01No\x05\x40\x02",
            )
        else:
            ...
            if wrapped_item_text != item_text:
                update_message_by_id(
                    messages,
                    0x405E,
                    "\x1aChomp chomp chomp...We have...\x01\x05\x41"
                    + wrapped_item_text
                    + "\x05\x40!\x04\x05\x41\x0860 Rupees\x05\x40 and it's yours!\x01Keyahahah!\x01\x1b\x05\x42Yes\x01No\x05\x40\x02",
                )
            else:
                update_message_by_id(
                    messages,
                    ...
                    "\x1aChomp chomp chomp...We have...\x01\x05\x41"
                    + item_text
                    + "\x05\x40! \x01Do you want it...huh? Huh?\x04\x05\x41\x0860 Rupees\x05\x40 and it's yours!\x01Keyahahah!\x01\x1b\x05\x42Yes\x01No\x05\x40\x02",
                )
        update_message_by_id(
            messages,
            0x4069,
            "You don't have enough money.\x01I can't sell it to you.\x01Chomp chomp...\x02",
        )
    ...
    if world.settings.shuffle_expensive_merchants:
        ...
        if "unique_merchants" not in world.settings.misc_hints:
            update_message_by_id(
                messages,
                0x6077,
                "\x06\x41Well Come!\x04I am selling stuff, strange and \x01rare, from all over the world to \x01everybody.\x01Today's special is...\x04A mysterious item! \x01Intriguing! \x01I won't tell you what it is until \x01I see the money....\x04How about \x05\x41200 Rupees\x05\x40?\x01\x01\x1b\x05\x42Buy\x01Don't buy\x05\x40\x02",
            )
        else:
            ...
            if wrapped_item_text != item_text:
                update_message_by_id(
                    messages,
                    0x6077,
                    "\x06\x41Well Come!\x04I am selling stuff, strange and \x01rare. Today's special is...\x01\x05\x41"
                    + wrapped_item_text
                    + "\x05\x40!\x04How about \x05\x41200 Rupees\x05\x40?\x01\x01\x1b\x05\x42Buy\x01Don't buy\x05\x40\x02",
                )
            else:
                update_message_by_id(
                    messages,
                    0x6077,
                    "\x06\x41Well Come!\x04I am selling stuff, strange and \x01rare, from all over the world to \x01everybody. Today's special is...\x01\x05\x41"
                    + wrapped_item_text
                    + "\x05\x40! \x01\x04How about \x05\x41200 Rupees\x05\x40?\x01\x01\x1b\x05\x42Buy\x01Don't buy\x05\x40\x02",
                )
        update_message_by_id(
            messages,
            0x6078,
            "Thank you very much!\x04The mark that will lead you to\x01the Spirit Temple is the \x05\x41flag on\x01the left \x05\x40outside the shop.\x01Be seeing you!\x02",
        )
        ...
        update_message_by_id(
            messages, 0x304C, "I have something cool right here.\x01How about it...\x07\x30\x4f\x02"
        )
        ...
        if "unique_merchants" not in world.settings.misc_hints:
            update_message_by_id(
                messages,
                0x304F,
                "How about buying this cool item for \x01200 Rupees?\x01\x1b\x05\x42Buy\x01Don't buy\x05\x40\x02",
            )
        else:
            ...
            if wrapped_item_text != item_text:
                update_message_by_id(
                    messages,
                    0x304F,
                    "For 200 Rupees, how about buying...\x04\x05\x41"
                    + wrapped_item_text
                    + "\x05\x40?\x01\x1b\x05\x42Buy\x01Don't buy\x05\x40\x02",
                )
            else:
                update_message_by_id(
                    messages,
                    0x304F,
                    "For 200 Rupees, how about buying \x01\x05\x41"
                    + item_text
                    + "\x05\x40?\x01\x1b\x05\x42Buy\x01Don't buy\x05\x40\x02",
                )
        ...
        if "unique_merchants" not in world.settings.misc_hints:
            update_message_by_id(
                messages,
                0x500C,
                "Mysterious item! How about\x01\x05\x41100 Rupees\x05\x40?\x01\x1b\x05\x42Buy\x01Don't buy\x05\x40\x02",
            )
        else:
            ...
            if wrapped_item_text != item_text:
                update_message_by_id(
                    messages,
                    0x500C,
                    "How about \x05\x41100 Rupees\x05\x40 for...\x04\x05\x41"
                    + wrapped_item_text
                    + "\x05\x40?\x01\x1b\x05\x42Buy\x01Don't buy\x05\x40\x02",
                )
            else:
                update_message_by_id(
                    messages,
                    0x500C,
                    "How about \x05\x41100 Rupees\x05\x40 for\x01\x05\x41"
                    + item_text
                    + "\x05\x40?\x01\x1b\x05\x42Buy\x01Don't buy\x05\x40\x02",
                )
    ...
    if world.settings.shuffle_tcgkeys != "vanilla":
        ...
        if "unique_merchants" not in world.settings.misc_hints:
            update_message_by_id(
                messages,
                0x6D,
                "I seem to have misplaced my\x01keys, but I have a fun item to\x01sell instead.\x04How about \x05\x4110 Rupees\x05\x40?\x01\x01\x1b\x05\x42Buy\x01Don't Buy\x05\x40\x02",
            )
        else:
            ...
            if wrapped_item_text != item_text:
                update_message_by_id(
                    messages,
                    0x6D,
                    "I seem to have misplaced my\x01keys, but I have a fun item to\x01sell instead.\x01How about \x05\x4110 Rupees\x05\x40 for...\x04\x05\x41"
                    + wrapped_item_text
                    + "\x05\x40?\x01\x1b\x05\x42Buy\x01Don't Buy\x05\x40\x02",
                )
            else:
                update_message_by_id(
                    messages,
                    0x6D,
                    "I seem to have misplaced my\x01keys, but I have a fun item to\x01sell instead.\x04How about \x05\x4110 Rupees\x05\x40 for\x01\x05\x41"
                    + item_text
                    + "\x05\x40?\x01\x1b\x05\x42Buy\x01Don't Buy\x05\x40\x02",
                )
        update_message_by_id(
            messages, 0x908B, "That's OK!\x01More fun for me.\x0b\x02", 0x00, allow_duplicates=True
        )
    ...
    if (
        world.settings.shuffle_pots != "off"
    ):  # Update the first BK door in ganon's castle to use a separate flag so it can be unlocked to get to the pots
        patch_ganons_tower_bk_door(
            rom, 0x15
        )  # Using flag 0x15 for the door. GBK doors normally use 0x14.
    ...
    if (
        ...
        or world.settings.shuffle_ganon_bosskey == "tokens"
    ):
    ...
    if (
        ...
        or world.settings.shuffle_ganon_bosskey == "hearts"
    ):
    ...
    rom.write_byte(
        rom.sym("CHEST_GILDED_TEXTURE"), "major" in world.settings.chest_textures_specific
    )
    rom.write_byte(
        rom.sym("CHEST_GOLD_TEXTURE"), "bosskeys" in world.settings.chest_textures_specific
    )
    rom.write_byte(
        rom.sym("CHEST_SILVER_TEXTURE"), "keys" in world.settings.chest_textures_specific
    )
    rom.write_byte(
        rom.sym("CHEST_SKULL_TEXTURE"), "tokens" in world.settings.chest_textures_specific
    )
    rom.write_byte(
        rom.sym("CHEST_HEART_TEXTURE"), "hearts" in world.settings.chest_textures_specific
    )
    ...
    if (
        world.settings.correct_chest_appearances == "classic"
        or world.settings.correct_chest_appearances == "both"
    ):
    ...
    # Specify which textures we want
    rom.write_byte(
        rom.sym("POTCRATE_GILDED_TEXTURE"), "major" in world.settings.potcrate_textures_specific
    )
    rom.write_byte(
        rom.sym("POTCRATE_GOLD_TEXTURE"), "bosskeys" in world.settings.potcrate_textures_specific
    )
    rom.write_byte(
        rom.sym("POTCRATE_SILVER_TEXTURE"), "keys" in world.settings.potcrate_textures_specific
    )
    rom.write_byte(
        rom.sym("POTCRATE_SKULL_TEXTURE"), "tokens" in world.settings.potcrate_textures_specific
    )
    rom.write_byte(
        rom.sym("POTCRATE_HEART_TEXTURE"), "hearts" in world.settings.potcrate_textures_specific
    )

    rom.write_byte(
        rom.sym("SOA_UNLOCKS_POTCRATE_TEXTURE"), world.settings.soa_unlocks_potcrate_texture
    )

    # give dungeon items the correct messages
    add_item_messages(messages, shop_items, world)
    if (
        world.settings.enhance_map_compass
        and world.settings.shuffle_mapcompass != "remove"
        and world.settings.world_count == 1
    ):
        dungeon_list = {
        ...
        for dungeon in world.dungeons:
            if dungeon.name in ("Gerudo Training Ground", "Ganons Castle"):
                ...
                if (
                    world.settings.mq_dungeons_mode == "random"
                    or world.settings.mq_dungeons_count != 0
                    and world.settings.mq_dungeons_count != 12
                ):
                    update_message_by_id(messages, map_id, map_message, allow_duplicates=True)
            else:
                dungeon_name, compass_id, map_id = dungeon_list[dungeon.name]
                if world.mixed_pools_bosses or world.settings.shuffle_dungeon_rewards not in (
                    "vanilla",
                    "reward",
                ):
                    ...
                    area = GossipText(
                        area.text(
                            world.settings.clearer_hints, preposition=True, use_2nd_person=True
                        ),
                        [area.color],
                        prefix="",
                        capitalize=False,
                    ...
                    if world.settings.logic_rules == "glitched":
                        ...
                        boss_location = next(
                            filter(
                                lambda loc: loc.type == "Boss",
                                world.get_entrance(
                                    f"{dungeon} Before Boss -> {dungeon.vanilla_boss_name} Boss Room"
                                ).connected_region.locations,
                            )
                        )
                ...
                if world.settings.shuffle_dungeon_rewards != "dungeon":
                    update_message_by_id(
                        messages, compass_id, compass_message, allow_duplicates=True
                    )
                if (
                    world.settings.mq_dungeons_mode == "random"
                    or world.settings.mq_dungeons_count != 0
    ...
    build_altar_hints(
        world,
        messages,
        include_rewards="altar" in world.settings.misc_hints
        and not world.settings.enhance_map_compass,
    ...
    for message_id in (0x706F, 0x7091, 0x7092, 0x7093, 0x7094, 0x7095):
        ...
        for code in get_message_by_id(messages, message_id).text_codes:
            if code.code == 0x04:  # box-break
                ...
                text_codes.append(code)
        update_message_by_id(
            messages, message_id, "".join(code.get_string() for code in text_codes)
        )
    ...
    if world.settings.blue_fire_arrows:
        rom.write_byte(
            0xC230C1, 0x29
        )  # Adds AT_TYPE_OTHER to arrows to allow collision with red ice
        rom.write_byte(
            0xDB38FE, 0xEF
        )  # disables ice arrow collision on secondary cylinder for red ice crystals
    ...
    if world.settings.auto_equip_masks:
        ...
        for mask_segment_id in range(0x00, 0x3C):
            if mask_segment_id not in (0x05, 0x06, 0x07, 0x0F, 0x15, 0x1C):
                rom.write_int16s(
                    0x00B66E60 + mask_segment_id * 0x12,
    ...
    if world.settings.shuffle_loach_reward == "easy":
        ...
        rom.write_int32(
            0xDC652C, 0x240100C8
        )  # replace 'mtc1 zero, f10' with 'addiu at, zero, 0x00c8'
        rom.write_int32(
            0xDC6540, 0xA6010192
        )  # replace 'sh v0, 0x0192(s0)' with 'sh at, 0x0192(s0)'
        rom.write_int32(
            0xDC6550, 0xE60601AC
        )  # replace 'swc1 f10, 0x01ac(s0)' with 'swc1 f6, 0x01ac(s0)'
...
def add_to_extended_object_table(
    rom: Rom, object_id: int, start_address: int, end_address: int
) -> None:
...
def get_override_table(world: World):
    return list(
        filter(lambda val: val is not None, map(get_override_entry, world.get_filled_locations()))
    )
...
def get_override_entry(location: Location) -> Optional[OverrideEntry]:
    ...
    if (
        ...
        and location.disabled != DisableType.ENABLED
    ):
        return None
    ...
    if location.type in ("NPC", "Scrub", "BossHeart", "Boss"):
        ...
        and location.vanilla_item in location.world.settings.shuffle_child_trade
    ):
        type = 0
...
def room_get_actors(
    rom: Rom,
    actor_func: Callable[[Rom, int, int, int], Any],
    room_data: int,
    scene: int,
...
def scene_get_actors(
    rom: Rom,
    actor_func: Callable[[Rom, int, int, int], Any],
    scene_data: int,
    scene: int,
    alternate: Optional[int] = None,
    processed_rooms: Optional[list[int]] = None,
) -> dict[int, Any]:
        ...
        if command == 0x18:  # Alternate header list
            ...
            for alt_id in range(0, 3):
                ...
                if header_data != 0 and not alternate:
                    actors.update(
                        scene_get_actors(
                            rom, actor_func, header_data, scene, scene_start, processed_rooms
                        )
                    )
                header_list = header_list + 4
...
def get_override_itemid(
    override_table: Iterable[OverrideEntry], scene: int, type: int, flags: int
) -> Optional[int]:
    ...
    def set_cow_id(rom: Rom, actor_id: int, actor: int, scene: int) -> None:
        ...
        if actor_id == 0x01C6:  # Cow
            ...
            if world.dungeon_mq["Jabu Jabus Belly"] and scene == 2:  # If it's an MQ jabu cow
                rom.write_int16(
                    actor + 0x8, 1 if cow_count == 17 else 0
                )  # Give all wall cows ID 0, and set cow 11's ID to 1
            else:
...
def set_grotto_shuffle_data(rom: Rom, world: World) -> None:
    ...
    for entrance in world.get_shuffled_entrances(type="Grotto"):
        if entrance.primary:
            ...
            rom.write_int16(
                rom.sym("GROTTO_EXIT_LIST") + 2 * entrance.data["grotto_id"],
                entrance.replaces.data["index"],
            )
...
def get_doors_to_unlock(rom: Rom, world: World) -> dict[int, list[int]]:
    def get_door_to_unlock(rom: Rom, actor_id: int, actor: int, scene: int) -> list[int]:
        ...
        if actor_id == 0x002E and door_type == 0x05:
            ...
            if setting == "remove" or (
                world.settings.shuffle_pots and scene == 0x0A and switch_flag == 0x15
            ):
                return [0x00D4 + scene * 0x1C + 0x04 + flag_byte, flag_bits]
...
def place_shop_items(
    rom: Rom, world: World, shop_items, messages, locations, init_shop_id: bool = False
) -> set[int]:
    if init_shop_id:
    ...
    for location in locations:
        if location.item.type == "Shop" or (
            ...
            and (
                ...
                or not world.settings.shuffle_child_trade
            ...
            ):  # only necessary for shuffling shop items, masks are treated like regular items when shuffled
            ...
            if not world.settings.complete_mask_quest and (
                (
                    location.vanilla_item == "Mask of Truth"
                    and "Mask of Truth" in world.settings.shuffle_child_trade
                )
                or (
                    "mask_shop" in world.settings.misc_hints
                    and location.vanilla_item == "Goron Mask"
                    and "Goron Mask" in world.settings.shuffle_child_trade
                )
                or (
                    "mask_shop" in world.settings.misc_hints
                    and location.vanilla_item == "Zora Mask"
                    and "Zora Mask" in world.settings.shuffle_child_trade
                )
                or (
                    "mask_shop" in world.settings.misc_hints
                    and location.vanilla_item == "Gerudo Mask"
                    and "Gerudo Mask" in world.settings.shuffle_child_trade
                )
            ):
            ...
            if item_display.dungeonitem:
                ...
                if world.settings.world_count > 1:
                    description_text = (
                        "\x08\x05\x41%s  %d Rupees\x01\x05\x42Player %d\x05\x40\x01Special deal! ONE LEFT!\x09\x0a\x02"
                        % (shop_item_name, shop_item.price, location.item.world.id + 1)
                    )
                else:
                    description_text = (
                        "\x08\x05\x41%s  %d Rupees\x01\x05\x40Special deal! ONE LEFT!\x01Get it while it lasts!\x09\x0a\x02"
                        % (shop_item_name, shop_item.price)
                    )
                purchase_text = (
                    "\x08%s  %d Rupees\x09\x01\x01\x1b\x05\x42Buy\x01Don't buy\x05\x40\x02"
                    % (shop_item_name, shop_item.price)
                )
...
def configure_dungeon_info(rom: Rom, world: World) -> None:
    ...
    rom.write_int32(
        rom.sym("CFG_DUNGEON_INFO_REWARD_ENABLE"),
        int("altar" in world.settings.misc_hints or enhance_map_compass),
    )
    rom.write_int32(
        rom.sym("CFG_DUNGEON_INFO_REWARD_NEED_COMPASS"),
        (
            (
                2
                if world.mixed_pools_bosses
                or world.settings.shuffle_dungeon_rewards not in ("vanilla", "reward")
                else 1
            )
            if enhance_map_compass and world.settings.shuffle_dungeon_rewards != "dungeon"
            else 0
        ),
    )
    rom.write_int32(
        rom.sym("CFG_DUNGEON_INFO_REWARD_NEED_ALTAR"),
        int(not enhance_map_compass and world.settings.shuffle_dungeon_rewards != "dungeon"),
    )
    rom.write_int32(
        rom.sym("CFG_DUNGEON_INFO_REWARD_SUMMARY_ENABLE"),
        int(
            not world.mixed_pools_bosses
            and world.settings.shuffle_dungeon_rewards in ("vanilla", "reward")
        ),
    )
    ...
    rom.write_byte(
        rom.sym("CFG_DUNGEON_INFO_REWARD_WORLDS_ENABLE"),
        int(
            world.settings.world_count > 1
            and world.settings.shuffle_dungeon_rewards
            in ("regional", "overworld", "any_dungeon", "anywhere")
        ),
    )
...
def patch_rupee_tower(location: Location, rom: Rom) -> None:
    if isinstance(location.default, tuple):
        ...
        raise Exception(
            f"Location does not have compatible data for patch_rupee_tower: {location.name}"
        )
