...
class SettingInfo:
    def __init__(
        self,
        setting_type: type,
        gui_text: Optional[str],
        gui_type: Optional[str],
        shared: bool,
        choices: Optional[dict | list] = None,
        default: Any = None,
        disabled_default: Any = None,
        disable: Optional[dict] = None,
        gui_tooltip: Optional[str] = None,
        ...
        self.gui_params: dict[str, Any] = (
            {} if gui_params is None else gui_params
        )  # additional parameters that the randomizer uses for the gui
        ...
        if shared:
            if self.gui_params.get("min") and self.gui_params.get("max") and not choices:
                self.bitwidth = math.ceil(
                    math.log(self.gui_params.get("max") - self.gui_params.get("min") + 1, 2)
                )
            else:
        ...
        if "distribution" not in self.gui_params and "randomize_key" in self.gui_params:
            if self.gui_type == "MultipleSelect":
                self.gui_params["distribution"] = [
                    (list(choice), 1) for choice in powerset(self.choice_list)
                ]
            else:
    ...
    def create_dependency(
        self, disabling_setting: "SettingInfo", option, negative: bool = False
    ) -> None:
        ...
        if self.dependency is None:
            ...
            self.dependency = lambda settings: op(
                getattr(settings, disabling_setting.name), option
            ) or old_dependency(settings)
...
class SettingInfoBool(SettingInfo):
    def __init__(
        ...
        disabled_default: Optional[bool] = None,
        disable: Optional[dict] = None,
        gui_tooltip: Optional[str] = None,
        gui_params: Optional[dict] = None,
        cosmetic: bool = False,
...
class SettingInfoStr(SettingInfo):
    def __init__(
        ...
        disabled_default: Optional[str] = None,
        disable: Optional[dict] = None,
        gui_tooltip: Optional[str] = None,
        gui_params: Optional[dict] = None,
        cosmetic: bool = False,
...
class SettingInfoInt(SettingInfo):
    def __init__(
        ...
        disabled_default: Optional[int] = None,
        disable: Optional[dict] = None,
        gui_tooltip: Optional[str] = None,
        gui_params: Optional[dict] = None,
        cosmetic: bool = False,
...
class SettingInfoList(SettingInfo):
    def __init__(
        ...
        disabled_default: Optional[list] = None,
        disable: Optional[dict] = None,
        gui_tooltip: Optional[str] = None,
        gui_params: Optional[dict] = None,
        cosmetic: bool = False,
...
class SettingInfoDict(SettingInfo):
    def __init__(
        ...
        disabled_default: Optional[dict] = None,
        disable: Optional[dict] = None,
        gui_tooltip: Optional[str] = None,
        gui_params: Optional[dict] = None,
        cosmetic: bool = False,
...
class Button(SettingInfoNone):
    def __init__(
        ...
        super().__init__(
            gui_text=gui_text, gui_type="Button", gui_tooltip=gui_tooltip, gui_params=gui_params
        )
...
class Textbox(SettingInfoNone):
    def __init__(
        ...
        super().__init__(
            gui_text=gui_text, gui_type="Textbox", gui_tooltip=gui_tooltip, gui_params=gui_params
        )
...
class Scale(SettingInfoInt):
    def __init__(
        ...
        choices = {i: str(i) for i in range(minimum, maximum + 1, step)}
