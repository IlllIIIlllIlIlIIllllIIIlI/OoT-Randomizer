...
class Sounds(Enum):
    ...
    BONGO_LOW = Sound(
        0x3950, "bongo-bongo-low", "Bongo Bongo Low", [Tags.QUIET, Tags.HPLOW, Tags.MENUMOVE]
    )
    BOTTLE_CORK = Sound(
        0x286C, "bottle-cork", "Bottle Cork", [Tags.IMMEDIATE, Tags.BRIEF, Tags.QUIET]
    )
    BOW_TWANG = Sound(0x1830, "bow-twang", "Bow Twang", [Tags.HPLOW, Tags.MENUMOVE])
    BUBBLE_LOL = Sound(0x38CA, "bubble-laugh", "Bubble Laugh", [])
    BUSINESS_SCRUB = Sound(
        0x3882, "business-scrub", "Business Scrub", [Tags.PAINFUL, Tags.NAVI, Tags.HPLOW]
    )
    ...
    CHANGE_ITEM = Sound(
        0x0835, "change-item", "Change Item", [Tags.IMMEDIATE, Tags.BRIEF, Tags.MENUSELECT]
    )
    CHEST_OPEN = Sound(0x2820, "chest-open", "Chest Open", [Tags.PAINFUL])
    CHILD_CRINGE = Sound(
        0x683A, "child-cringe", "Child Cringe", [Tags.PAINFUL, Tags.IMMEDIATE, Tags.MENUSELECT]
    )
    ...
    CHILD_SCREAM = Sound(
        ...
        "child-scream",
        "Child Scream",
        [Tags.PAINFUL, Tags.IMMEDIATE, Tags.MENUSELECT, Tags.HORSE],
    )
    CUCCO_CLUCK = Sound(0x2812, "cluck", "Cluck", [Tags.BRIEF, Tags.NAVI, Tags.HPLOW])
    CUCCO_CROW = Sound(
        0x2813, "cockadoodledoo", "Cockadoodledoo", [Tags.PAINFUL, Tags.NAVI, Tags.NIGHTFALL]
    )
    ...
    FLARE_BOSS_LOL = Sound(
        0x3981,
        "flare-dancer-laugh",
        "Flare Dancer Laugh",
        [Tags.PAINFUL, Tags.IMMEDIATE, Tags.HOVERBOOT],
    )
    ...
    GREAT_FAIRY = Sound(
        0x6858, "great-fairy", "Great Fairy", [Tags.PAINFUL, Tags.NAVI, Tags.NIGHTFALL, Tags.HORSE]
    )
    ...
    REDEAD_SCREAM = Sound(
        0x38E5, "redead-scream", "Redead Scream", [Tags.PAINFUL, Tags.NAVI, Tags.HORSE]
    )
    ...
    SHABOM_POP = Sound(
        0x3949, "shabom-pop", "Shabom Pop", [Tags.IMMEDIATE, Tags.BRIEF, Tags.HOVERBOOT]
    )
    ...
    STALCHILD_ATTACK = Sound(
        0x3831, "stalchild-attack", "Stalchild Attack", [Tags.PAINFUL, Tags.HORSE]
    )
    ...
    TAMBOURINE = Sound(
        0x4842, "tambourine", "Tambourine", [Tags.QUIET, Tags.NAVI, Tags.HPLOW, Tags.HOVERBOOT]
    )
    ...
    TWINROVA_BICKER = Sound(
        0x39E7, "twinrova-bicker", "Twinrova Bicker", [Tags.LOOPED, Tags.PAINFUL]
    )
    WOLFOS_HOWL = Sound(0x383C, "wolfos-howl", "Wolfos Howl", [Tags.PAINFUL])
    ZELDA_ADULT_GASP = Sound(
        0x6879, "adult-zelda-gasp", "Zelda Gasp (Adult)", [Tags.NAVI, Tags.HPLOW]
    )
...
class SoundHooks(Enum):
    ...
    MENU_SELECT = SoundHook(
        "Menu Select",
        no_painful + menu_select,
        [
            0xBA1BBE,
            0xBA23CE,
            0xBA2956,
    ...
    MENU_CURSOR = SoundHook(
        "Menu Cursor",
        no_painful + menu_cursor,
        [
            0xBA165E,
            0xBA1C1A,
            0xBA2406,
    ...
    GET_SMALL_ITEM = SoundHook(
        "Get Small Item", standard, [0xBDA00E, 0xBE9B4A, 0xBD9FFA, 0xA88EA2], False
    )
    ...
    CUCCO = SoundHook(
        ...
        [
            ...
            0xC29B82,
            0xC2A3BA,
            0xC2A3A6,  # Normal cuccos
            0xE2841E,  # Attacking cuccos
            0xE262B6,
            0xE267EE,
            0xE26846,
            0xE26B1E,
            0xE26B36,  # Bowling cuccos
            0xBEACCE,
            0xE2109A,
            0xAFD942,  # Chicken, Pocket cucco and Cojiro
        ],
        False,
    )
