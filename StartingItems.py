...
Entry = namedtuple(
    "Entry", ["setting_name", "item_name", "available", "gui_text", "special", "ammo", "i"]
)
...
def _entry(
    ...
    special: bool = False,
    ammo: Optional[dict[str, tuple[int, ...]]] = None,
...
inventory: dict[str, Entry] = dict(
    chain(
        ...
        _entry(
            "ocarina_c_right_button", "Ocarina C right Button", gui_text="Ocarina C right Button"
        ),
    )
)

songs: dict[str, Entry] = dict(
    chain(
...
equipment: dict[str, Entry] = dict(
    chain(
        ...
        _entry(
            "strength", "Progressive Strength Upgrade", available=3, gui_text="Progressive Strength"
        ),
