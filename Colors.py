...
a_button_colors: dict[str, tuple[Color, Color, Color, Color, Color, Color, Color]] = {
    "N64 Blue": (
        ...
        Color(0x00, 0x50, 0xC8),
        Color(0x00, 0x50, 0xFF),
        Color(0x64, 0x64, 0xFF),
        Color(0x00, 0x32, 0xFF),
        Color(0x00, 0x64, 0xFF),
        Color(0x50, 0x96, 0xFF),
    ),
    "N64 Green": (
        Color(0x00, 0x96, 0x00),
        Color(0x00, 0x96, 0x00),
        Color(0x00, 0x96, 0x00),
        Color(0x64, 0x96, 0x64),
        Color(0x00, 0x96, 0x00),
        Color(0x00, 0x96, 0x00),
        Color(0x00, 0x96, 0x00),
    ),
    "N64 Red": (
        Color(0xC8, 0x00, 0x00),
        Color(0xC8, 0x00, 0x00),
        Color(0xC8, 0x00, 0x00),
        Color(0xC8, 0x64, 0x64),
        Color(0xC8, 0x00, 0x00),
        Color(0xC8, 0x00, 0x00),
        Color(0xC8, 0x00, 0x00),
    ),
    "GameCube Green": (
        Color(0x00, 0xC8, 0x32),
        Color(0x00, 0xC8, 0x50),
        Color(0x00, 0xFF, 0x50),
        Color(0x64, 0xFF, 0x64),
        Color(0x00, 0xFF, 0x32),
        Color(0x00, 0xFF, 0x64),
        Color(0x50, 0xFF, 0x96),
    ),
    "GameCube Red": (
        Color(0xFF, 0x1E, 0x1E),
        Color(0xC8, 0x00, 0x00),
        Color(0xFF, 0x00, 0x50),
        Color(0xFF, 0x64, 0x64),
        Color(0xFF, 0x1E, 0x1E),
        Color(0xFF, 0x1E, 0x1E),
        Color(0xFF, 0x1E, 0x1E),
    ),
    ...
    "Yellow": (
        ...
        Color(0xFF, 0x96, 0x00),
        Color(0xFF, 0xFF, 0x32),
    ),
    "Black": (
